...
/**
 * Worker-Threads zur (auditlog)serverseitigen Bedienung einer Session mit dem ChatServer als Client.
 * Dem ChatServer als Client werden (auditlog)serverseitig Worker-Threads zugeordnet.
 *
 * @author Peter Mandl (geänd. E.Nicole Harmat)
 *
 */
public class AuditLogWorkerThreadImpl extends AbstractWorkerThread {
	 ...
	 *          Zu sendende PDU
	 */
	/*protected void sendLoginListUpdateEvent(AuditLogPDU pdu) {
